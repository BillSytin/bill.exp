...
public class ModelConvert {
    ...
    private static <T> T deserialize(Reader reader, Class<T> resultType) throws IOException {
    ...
    private static Writer serialize(Writer writer, Object value) throws IOException {
